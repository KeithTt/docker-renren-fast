...
3、修改conf/settings.xml文件，设置jar包存放目录
...
6、下载renren-fast项目，将项目导入到eclipse
http://www.renren.io/
...
12、给eclipse安装sts插件
https://jingyan.baidu.com/article/93f9803f52395ce0e56f556a.html
...
4、创建5个数据卷。由于通过映射宿主机的磁盘到容器中时，PXC无法方式正常启动。这里使用docker volume来创建卷
...
2、将dist目录的文件拷贝到宿主机的/home/fn1/renren-vue、/home/fn2/renren-vue、/home/fn3/renren-vue的目录下面
...
4、Swarm集群自带一个叫ingress的overlay共享网络，不过这个网络是用来管理swarm集群的，而不是用于业务容器之间的通信的
# docker network ls
...
b、任何角色节点，删除前需要停止节点上的docker服务
# systemctl stop docker

c、删除节点
# docker node rm NodeID

d、work节点停掉docker服务，删除node即可
